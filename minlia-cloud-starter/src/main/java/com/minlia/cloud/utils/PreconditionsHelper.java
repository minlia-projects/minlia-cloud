...
public class PreconditionsHelper {
    ...
    protected static Logger logger = LoggerFactory.getLogger(PreconditionsHelper.class);
    ...
    public static Boolean containsStr(String source, String str) {
        return PreconditionsHelper.isNotEmpty(source) && source.contains(str);
    }
    ...
    public static String subMaxString(String str, Integer length) {
        if (PreconditionsHelper.isNotEmpty(str) && str.length() > length) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (realLength > length) {
                    str = PreconditionsHelper.toAppendStr(replaceBlank(str).substring(0, i), "...");
                    break;
                }
            }
        }
    ...
    public static String replaceBlank(String str) {
        String dest = "";
        if (PreconditionsHelper.isNotEmpty(str)) {
    ...
    public static Double round(Object value, int count) {
        return round(PreconditionsHelper.parseDouble(value), count);
    }
    ...
    public static void sortList(List list, List sourcelist, String parentId) {
        if (PreconditionsHelper.isNotEmpty(sourcelist) && PreconditionsHelper.isNotEmpty(parentId)) {
    ...
    public static String toStrString(Object obj) {
        if (PreconditionsHelper.isNotEmpty(obj)) {
