...
//import com.minlia.cloud.annotation.DictType;
//import com.minlia.cloud.annotation.JsonField;
...
//        initConfig();
//        if (StringHelper.isNotEmpty(kindIds)) {
...
//        return JSON.toJSONStringWithDateFormat(obj, StringHelper.TIME_FORMAT, SerializerFeature.WriteDateUseDateFormat);
//    }
//
//    /**
//     * @param obj
...
//        boolean flag = false;
//        if (className != null && StringHelper.isNotEmpty(name))
...
//        if (StringHelper.isNotEmpty(list) && StringHelper.isNotEmpty(attributes) && attributes.contains("|")) {
...
//        if (StringHelper.isNotEmpty(col)) {
...
//                    targert.add(map);
//                }
//                if (StringHelper.isNotEmpty(targert))
...
//     * @return
//     */
//    public JSONObject toJsonPageObject(PageableResponseBody<?> pm, String attributes) {
//        JSONObject jsonObj = null;
//        if (pm != null) {
//            Map<String, Object> map = objToMap(pm, false);
//            List<Object> list = toListMap((List<Object[]>) map.get(PageableResponseBody.F_DATA), attributes);
//            map.put(PageableResponseBody.F_DATA, list);
//            jsonObj = new JSONObject(map);
//        } else {
...
//        Map<String, Object> maps = new HashMap<String, Object>();
//        try {
//            if (StringHelper.isNotEmpty(objs)) {
//                String attr = null;
//                Object val = null;
...
//                    if (attr.contains("."))
//                        attr = attr.replace(".", "_");
//                    if (StringHelper.isNotEmpty(kindIds) && StringHelper.isNotEmpty(codeItemData)
//                            && StringHelper.isNotEmpty(keyCodeItems) && keyCodeItems.contains(attr)) {
//                        val = codeItemData.getJSONObject(kindIds.get(keyCodeItems.indexOf(attr))).get((String) objs[i]);
//                    } else {
//                        val = objs[i];
//                    }
//                    if (val instanceof Date)
//                        val = StringHelper.fmtDate((Date) val);
//                    maps.put(attr, val);
//                }
//            }
//        } catch (Exception e) {
...
//                    throw new ApiException("自定义class为空,无法正常解析对象");
//                }
...
////						continue;
//                    if (StringHelper.isNotEmpty(clsName)) {
//                        List<String> argList = Lists.newArrayList(clsName);
//                        key = StringHelper.toAppendStr(Collections3.convertToString(argList, "_"), "_", key);
//                    }
//                    if (StringHelper.isEmpty(val) && jf != null && jf.serialzeFeatures() != null) {
...
//                            if (StringHelper.isNotEmpty(recurrenceStrList) && !key.contains("_")) {
//                                for (String reKey : recurrenceStrList) {
//                                    if (reKey.startsWith(StringHelper.toAppendStr(key, "_"))
//                                            && reKey.indexOf("_") != -1) {
//                                        tempReKey.add(reKey);
//                                    }
//                                }
//                            }
//                            if (StringHelper.isNotEmpty(tempReKey)) {
...
//                if (StringHelper.isEmpty(keyCodeItems) || !keyCodeItems.contains(fieldName)) {
...
//        try {
//            if (jf != null && StringHelper.isNotEmpty(jf.name()))
//                key = jf.name();
//        } catch (Exception e) {
//        }
...
//                    if (StringHelper.isNotEmpty(item)) {
...
//        if (StringHelper.isNotEmpty(kindIds) && StringHelper.isNotEmpty(keyCodeItems) && keyCodeItems.contains(key)) {
...
//            val = StringHelper.fmtDate((ZonedDateTime) val);
//        return val;
//    }
//
//}
