...
//        return Json.toJSONStringWithDateFormat(obj, PreconditionsHelper.TIME_FORMAT, SerializerFeature.WriteDateUseDateFormat);
//    }
//
...
//        return toJSONString(object, PreconditionsHelper.TIME_FORMAT, Lists.newArrayList(filters), false);
//    }
//
...
//            if (PreconditionsHelper.isNotEmpty(dataFmt))
