...
public class PageableResponseBody<T> implements Pageable, Serializable {
     ...
     */
    public PageableResponseBody(int page, int size) {
        this(page, size, null);
    }

    public PageableResponseBody(int page, int size, List<T> dataList, long recordsTotal) {
        this(page, size, null);
        setData(dataList);
     ...
     */
    public PageableResponseBody(int page, int size, Direction direction, String... properties) {
     ...
     */
    public PageableResponseBody(int page, int size, Sort sort) {
        if (page < 0) {
    ...
    public boolean equals(Object obj) {
        ...
        PageableResponseBody other = (PageableResponseBody) obj;
     ...
     */
    public PageableResponseBody previous() {
        return getPageNumber() == 0 ? this : new PageableResponseBody(getPageNumber() - 1, getPageSize(), getSort());
    }
    ...
    public <S> PageableResponseBody<S> map(Converter<? super T, ? extends S> converter) {
        return new PageableResponseBody(this.getPage(), this.getSize(),
